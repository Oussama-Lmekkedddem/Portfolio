        ...
        <section className={`w-full h-[900px]`}>
            ...
            <div className={`relative w-full max-w-7xl mx-auto sm:px-12 px-6 sm:py-12 py-16`}>
                ...
                <motion.div className="flex flex-col md:flex-row md:flex-wrap w-full gap-2"
                        ...
                        <figure className="bg-transparent rounded-xl p-8 dark:bg-transparent">
                            <div className="pt-3 space-y-4">
                                ...
                                {personnelInfos.resume ? (
                                    <figcaption>
                                        <button
                                            onClick={() =>    {if (typeof window !== 'undefined') {window.open(personnelInfos.resume, "_blank")}}}
                    ...
                    <div className="border-r-2 border-b-2 border-[#3F3F3F] rounded-[20px] pt-12 flex-1 h-full min-h-80 flex flex-col sm:flex-row sm:flex-wrap w-full gap-2">
                        <div className="flex-1 h-full">
                            <div className="w-full flex justify-center items-center">
                                <div className={`${styles.heroSubText} lg:text-[55px] lg:mb-3 md:mb-1 uppercase`}>Education</div>
                            </div>
